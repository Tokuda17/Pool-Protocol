...
async function panRemoveLiquidityAVAX(
  routerContract,
  tokenA,
  liquidity,
  walletAddress
  ...
  try {
    ...
    const deadline = BigNumber(block.timestamp).add(20).toString();
    ...
    throw new Error(e.message + " => panRemoveLiquidity failed");
  }
}

async function panRemoveLiquidity(
  routerContract,
  tokenA,
  tokenB,
  liquidity,
