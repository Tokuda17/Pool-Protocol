...
async function main() 
{
  try {
    ...
    let allow = await erc20.allowance(tokenAContract,"0x0fFeb87106910EEfc69c1902F411B431fFc424FF", bankAddress);
    let approve = await erc20.approve(tokenAContract,"0x0fFeb87106910EEfc69c1902F411B431fFc424FF", bankAddress, amt);
    ...
    approve = await erc20.approve(tokenBContract,wallet.address, bankAddress, amt);
