...
const fromToken = '0x4200000000000000000000000000000000000042';                  //this is the token address that you want to sell
const toToken = '0x4200000000000000000000000000000000000006';                    //this is the token address that you want to buy
const fromAmount = '10000000000000000';                                                          //this is the amount of tokens you want to sell, make sure it's in minimum divisible units
const toAmount = '80790000000000';
...
console.log("nf=",nf);
    let fetchPromise = await nf("https://api.1inch.dev/orderbook/v3.0/"+chainId, {
        "headers": {
