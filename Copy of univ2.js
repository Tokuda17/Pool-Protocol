...
async function getPositions(wname,walletAddress,q)
{
  ...
  bal = BigNumber(Math.floor(0.000124058839102555*10000000000)).mult(BigNumber(10).pow(18-10)).toString();
  console.log("bal=",bal);
  ...
  let samt = parseInt(BigNumber(r._reserve0).mult(Math.floor(parseFloat(ownership)*100000000)).div(100000000).toString())/1000000;
  let vamt = parseInt(BigNumber(r._reserve1).mult(Math.floor(parseFloat(ownership)*100000000)).div(BigNumber(10).pow(8+18-6)).toString())/1000000;

  let vBig = BigNumber(Math.floor(vamt * 1000000)).mult(BigNumber(10).pow(18-6)).toString();
