...
const settingsOp = {
  apiKey: 'rHtq3eFE7jm_xUmUNJOOOg4LR9wngukb',
  network: alchemy.Network.OPT_MAINNET
};
const aProviderOp = new alchemy.Alchemy(settingsOp);
console.log("alchemy=",aProviderOp);
const providerOp = aProviderOp.core;
*/

console.log("unifees p=",ethers);
//const providerOp = new ethers.providers.JsonRpcProvider("https://opt-mainnet.g.alchemy.com/v2/rHtq3eFE7jm_xUmUNJOOOg4LR9wngukb","optimism");
//const providerPoly = new ethers.providers.JsonRpcProvider("https://polygon-mainnet.g.alchemy.com/v2/AmllS7MVSHEnkL8dxIWD0QiDQhMWe5Ry");
...
async function main()
{
  const {f0,f1} = await getFees("0x0fFeb87106910EEfc69c1902F411B431fFc424FF",430408);
console.log("Fee0:",f0);
console.log("Fee1:",f1);
}
main();
