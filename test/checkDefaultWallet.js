...
async function main(retries=0) 
{
  ...
  try {
    ...
    if (transfer > 0)
    {
      transfer = BigNumber(Math.floor(transfer * 1000)).mult(BigNumber(10).pow(15)).toString();
      console.log("transfer=",transfer);
      await web3.obj.eth.sendTransaction({from: lanceAddress, to: defaultAddress, value: transfer, gasLimit: 21000, gasPrice: 25000000000});
    }
  } catch (e) {
