...
const providerArb = new ethers.providers.JsonRpcProvider("https://arb-mainnet.g.alchemy.com/v2/-aIjTJiAjkaQVE7aJio0ew42h0b39iZf");
const providerEth = new ethers.providers.JsonRpcProvider("https://eth-mainnet.g.alchemy.com/v2/0cbue9UUJ2iTntNKop8bnJTujqtNAwbS");
...
function getFusion(ch)
{
  ...
  if (!f)
    throw new Error("getFusion("+ch+") failed");
  return f;
}
...
async function init(ch)
{
  ...
  else if (ch == "arb")
  {
    ...
    throw Error("chain not defined in web3.js web3.init()");
