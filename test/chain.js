...
function isNative(sym,chain=false)
{
  if (chain)
    ch = chain;
  if (ch == "op")
    return op.isNative(sym);
  else if (ch == "poly")
    return poly.isNative(sym);
  else if (ch == "avax")
    return avax.isNative(sym);
  else
  {
...
function isNativeEquivalent(sym,chain=false)
{
  ...
  if (chain)
    ch = chain;
  if (ch == "op")
    return op.isNativeEquivalent(sym);
  else if (ch == "poly")
    return poly.isNativeEquivalent(sym);
  else if (ch == "avax")
    return avax.isNativeEquivalent(sym);
  else if (ch == "arb")
    return ["ETH","WETH"].includes(sym);
  else
  {
