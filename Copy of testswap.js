...
//let addr = '0x6b3A6E624e660dbB69f4cf2fd3Bba760e8EbAd56';
  //await inch.swap(chain.getAddress("WAVAX"),chain.getAddress("USDC"),"10000000000000000",wallet.address);
  //await inch.swap(avaxAddr,usdcAddr,"10000000000000000",addr);
  //await inch.swap("OP","WETH",0.1,wallet.address);
  await inch.swap("WAVAX","USDC",0.1,wallet.address);
/*
